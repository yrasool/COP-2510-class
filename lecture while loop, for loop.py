...
for i in  range (1,5):
    print(i)
    break # this causes the loop to end after one iteration #hence the output is 1 and the else clause doesn't run and the second loop doesn't start 
#bc the for loop is interrupted so we dont get the output of 2,3,4
...
for i in range (1,11):
    ...
    print("Loop completed without interruptions") # the output is 1,2,3,5,6,7,8,9,10,Loop completed without interruptions
